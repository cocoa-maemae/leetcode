...
class Solution {
    public int minFlips(int a, int b, int c) {
        ...
        for (int i = 0; i < 32; ++i) {
            ...
            // ith bits of a | b and c are not same.
            if ((equal & mask) > 0)
                ...
                // If ith bits of a and b are both 1 and that of c is 0
                ans += (a & mask) == (b & mask) && (c & mask) == 0 ? 2 : 1;

                // If a=2(10),b=6(110),c=5(101)
                //i=1, 10&01=0 == 110&001=0 && 101&001=1 -> +1
                //i=2, 10&10=10 == 110&010=10 && 101&010=0 -> +2            
        }
        return ans;
    }
}
